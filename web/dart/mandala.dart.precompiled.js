...
DrawingTool: {"": "Object;mandalaId,_sides,_isMirrored,_allowEditingPoints,_scale,_isDragging,_blurAmount,_blurOpacity,_canvas,_ctx,_offscreenBuffer,_bgGradient,_bgGradientSvg,_gradientStart,_gradientEnd,_arcColor,_canvasRect,_winScroll,_rafId,actionQueue",
  ...
  _setupListeners$0: function() {
    ...
    t1 = $.get$SharedDispatcher_emitter();
    t1.on$2(t1, "InterfaceEvent.ON_CONFIRMED", this.get$onConfirmed());
  },
  start$0: function(_) {
    var t1, t2;
    t1 = window;
  ...
  _updateOffscreenBuffer$0: function() {
    ...
    P.print("_updateOffscreenBuffer");
    ...
    switch (actionName) {
      ...
      case "alpha":
        ...
        if (J.get$length$asx(J.get$points$x(t1.get$last(t1))) === 0 && t1.get$length(t1) >= 2)
          t1.elementAt$1(t1, t1.get$length(t1) - 2).get$settings().opacity = value;
  ...
  get$onConfirmed: function() {
    return new R.BoundClosure$1(this, R.DrawingTool.prototype.onConfirmed$1, null, "onConfirmed$1");
  },
...
DrawingTool__setupListeners_closure9: {"": "Closure;this_10",
  call$1: function(e) {
    var t1 = this.this_10.actionQueue;
...
PolygonalStrokeAction: {"": "BaseAction;_activePoints,_potentialNextPoint,_draggedPoint,points,name,settings",
  ...
  onConfirmed$0: function() {
    ...
    this.inputUp$2(J.get$last$ax(t1), true);
  },
...
PolygonalStrokeAction$: function() {
  ...
  H.setRuntimeTypeInfo(t1, [Z.Point]);
  t1 = new R.PolygonalStrokeAction(null, null, null, t1, "PolygonalStroke", new R.ActionSettings(0.5, 0.5, "rgba(255,255,255,0.25)", "rgba(255,255,255,0.25)", new R.ColorValue(255, 255, 255), new R.ColorValue(255, 255, 255)));
...
SmoothStrokeAction: {"": "RegularStrokeAction;_draggedPoint,_activePoints,points,name,settings",
  ...
  inputDown$2: function(pos, canEditPoints) {
    ...
    R.RegularStrokeAction.prototype.inputDown$2.call(this, pos, canEditPoints);
  },
  inputMove$2: function(pos, isDrag) {
    var t1 = this._draggedPoint;
    if (t1 != null) {
    ...
    R.RegularStrokeAction.prototype.inputMove$2.call(this, pos, isDrag);
  },
  inputUp$1: function(pos) {
    var t1, simplifiedSmoothedPoints;
    if (this._draggedPoint != null) {
      this._draggedPoint = null;
      return;
    }
...
SmoothStrokeAction$: function() {
  var t1 = P.List_List(null, Z.Point);
  H.setRuntimeTypeInfo(t1, [Z.Point]);
  t1 = new R.SmoothStrokeAction(null, null, t1, "RegularStroke", new R.ActionSettings(0.5, 0.5, "rgba(255,255,255,0.25)", "rgba(255,255,255,0.25)", new R.ColorValue(255, 255, 255), new R.ColorValue(255, 255, 255)));
  t1.SmoothStrokeAction$0();
  return t1;
}}
...
DrawingToolInterface: {"": "Object;_drawingModule,_lastSelectedTool,_DrawingToolLib$_$sideCountSlider,_DrawingToolLib$_$scaleSlider,_DrawingToolLib$_$opacitySlider,_DrawingToolLib$_$lineWidthSlider,_DrawingToolLib$_$mirrorCheckbox,_DrawingToolLib$_$drawPointsCheckbox,_DrawingToolLib$_$advancedToggleButton,_helperText",
  _setupOutgoingEvents$0: function() {
    ...
    H.setRuntimeTypeInfo(t1, [null]);
    t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.DrawingToolInterface__setupOutgoingEvents_closure1()), t1._useCapture);
    H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t3._tryResume$0();
    ...
    t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.DrawingToolInterface__setupOutgoingEvents_closure7(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t3._tryResume$0();
    ...
    $.get$context().callMethod$2("jQuery", ["#interface-color-line-slider"]).callMethod$2("spectrum", [P.JsObject_JsObject$jsify(H.fillLiteralMap(["showPalette", true, "showPaletteOnly", true, "palette", ["#FFFFFF", "#00ecfc", "#ffdf34", "#ef43ff"], "change", P.JsFunction_JsFunction$withThis(new R.DrawingToolInterface__setupOutgoingEvents_closure8(this))], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)))]);
    $.get$context().callMethod$2("jQuery", ["#interface-color-gradient-start-slider"]).callMethod$2("spectrum", [P.JsObject_JsObject$jsify(H.fillLiteralMap(["change", P.JsFunction_JsFunction$withThis(new R.DrawingToolInterface__setupOutgoingEvents_closure9(this))], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)))]);
    $.get$context().callMethod$2("jQuery", ["#interface-color-gradient-end-slider"]).callMethod$2("spectrum", [P.JsObject_JsObject$jsify(H.fillLiteralMap(["change", P.JsFunction_JsFunction$withThis(new R.DrawingToolInterface__setupOutgoingEvents_closure10(this))], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)))]);
  ...
  _setupIncommingEvents$0: function() {
    ...
    t1 = $.get$SharedDispatcher_emitter();
    t1.on$2(t1, "ActionEvent.ON_BECAME_UNCONFIRMED", this.get$onActionBecameUnconfirmed());
    t1 = $.get$SharedDispatcher_emitter();
    t1.on$2(t1, "ActionEvent.ON_BECAME_CONFIRMABLE", this.get$onActionBecameConfirmable());
  },
  onActionBecameUnconfirmed$1: function(actionName) {
    J.$index$asx($.get$context(), "TweenMax").callMethod$2("to", [this._helperText, 0.15, P.JsObject_JsObject$jsify(H.fillLiteralMap(["alpha", 0, "display", "none"], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)))]);
  },
  get$onActionBecameUnconfirmed: function() {
    return new R.BoundClosure$1(this, R.DrawingToolInterface.prototype.onActionBecameUnconfirmed$1, null, "onActionBecameUnconfirmed$1");
  },
  onActionBecameConfirmable$1: function(instructions) {
    ...
    J.$index$asx($.get$context(), "TweenMax").callMethod$2("fromTo", [this._helperText, 0.5, P.JsObject_JsObject$jsify(H.fillLiteralMap(["scale", "1.2", "alpha", 0.5, "display", "block"], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null))), P.JsObject_JsObject$jsify(H.fillLiteralMap(["scale", "1", "alpha", 1, "display", "block"], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)))]);
  },
  get$onActionBecameConfirmable: function() {
    return new R.BoundClosure$1(this, R.DrawingToolInterface.prototype.onActionBecameConfirmable$1, null, "onActionBecameConfirmable$1");
  },
...
DrawingToolInterface__setupOutgoingEvents__closure0: {"": "Closure;this_1,el_2",
  call$1: function(e) {
    var t1, t2;
    t1 = this.this_1;
    t2 = J.get$attributes$x(this.el_2)._element.getAttribute("data-drawingmode");
    P.print("CHANGEME");
    t1._drawingModule.changeAction$1(t2);
...
DrawingToolInterface__setupOutgoingEvents_closure1: {"": "Closure;",
  call$1: function(e) {
...
DrawingToolInterface__setupOutgoingEvents_closure2: {"": "Closure;this_6",
  call$1: function(e) {
    var t1 = this.this_6;
...
DrawingToolInterface__setupOutgoingEvents_closure3: {"": "Closure;this_7",
  call$1: function(e) {
    var t1 = this.this_7;
...
DrawingToolInterface__setupOutgoingEvents_closure4: {"": "Closure;this_8",
  call$1: function(e) {
    var t1 = this.this_8;
...
DrawingToolInterface__setupOutgoingEvents_closure5: {"": "Closure;this_9",
  call$1: function(e) {
    var t1 = this.this_9;
...
DrawingToolInterface__setupOutgoingEvents_closure6: {"": "Closure;this_10",
  call$1: function(e) {
    var t1 = this.this_10;
...
DrawingToolInterface__setupOutgoingEvents_closure7: {"": "Closure;this_11",
  call$1: function(e) {
    var t1 = this.this_11;
...
DrawingToolInterface__setupOutgoingEvents_closure8: {"": "Closure;this_12",
...
DrawingToolInterface__setupOutgoingEvents_closure9: {"": "Closure;this_13",
  call$2: function(element, color) {
...
DrawingToolInterface__setupOutgoingEvents_closure10: {"": "Closure;this_14",
  call$2: function(element, color) {
...
DrawingToolInterface__setupOutgoingEvents_closure11: {"": "Closure;this_15",
  call$0: function() {
...
function dart_precompiled($collectedClasses) {
  ...
  function DrawingToolInterface__setupOutgoingEvents_closure1() {
  }
  ...
  function DrawingToolInterface__setupOutgoingEvents_closure2(this_6) {
    this.this_6 = this_6;
  }
  ...
  function DrawingToolInterface__setupOutgoingEvents_closure3(this_7) {
    this.this_7 = this_7;
  }
  ...
  function DrawingToolInterface__setupOutgoingEvents_closure4(this_8) {
    this.this_8 = this_8;
  }
  ...
  function DrawingToolInterface__setupOutgoingEvents_closure5(this_9) {
    this.this_9 = this_9;
  }
  ...
  function DrawingToolInterface__setupOutgoingEvents_closure6(this_10) {
    this.this_10 = this_10;
  }
  ...
  function DrawingToolInterface__setupOutgoingEvents_closure7(this_11) {
    this.this_11 = this_11;
  }
  DrawingToolInterface__setupOutgoingEvents_closure7.builtin$cls = "DrawingToolInterface__setupOutgoingEvents_closure7";
  if (!"name" in DrawingToolInterface__setupOutgoingEvents_closure7)
    DrawingToolInterface__setupOutgoingEvents_closure7.name = "DrawingToolInterface__setupOutgoingEvents_closure7";
  $desc = $collectedClasses.DrawingToolInterface__setupOutgoingEvents_closure7;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingToolInterface__setupOutgoingEvents_closure7.prototype = $desc;
  function DrawingToolInterface__setupOutgoingEvents_closure8(this_12) {
    this.this_12 = this_12;
  }
  DrawingToolInterface__setupOutgoingEvents_closure8.builtin$cls = "DrawingToolInterface__setupOutgoingEvents_closure8";
  if (!"name" in DrawingToolInterface__setupOutgoingEvents_closure8)
    DrawingToolInterface__setupOutgoingEvents_closure8.name = "DrawingToolInterface__setupOutgoingEvents_closure8";
  $desc = $collectedClasses.DrawingToolInterface__setupOutgoingEvents_closure8;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingToolInterface__setupOutgoingEvents_closure8.prototype = $desc;
  function DrawingToolInterface__setupOutgoingEvents_closure9(this_13) {
    this.this_13 = this_13;
  }
  DrawingToolInterface__setupOutgoingEvents_closure9.builtin$cls = "DrawingToolInterface__setupOutgoingEvents_closure9";
  if (!"name" in DrawingToolInterface__setupOutgoingEvents_closure9)
    DrawingToolInterface__setupOutgoingEvents_closure9.name = "DrawingToolInterface__setupOutgoingEvents_closure9";
  $desc = $collectedClasses.DrawingToolInterface__setupOutgoingEvents_closure9;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingToolInterface__setupOutgoingEvents_closure9.prototype = $desc;
  function DrawingToolInterface__setupOutgoingEvents_closure10(this_14) {
    this.this_14 = this_14;
  }
  DrawingToolInterface__setupOutgoingEvents_closure10.builtin$cls = "DrawingToolInterface__setupOutgoingEvents_closure10";
  if (!"name" in DrawingToolInterface__setupOutgoingEvents_closure10)
    DrawingToolInterface__setupOutgoingEvents_closure10.name = "DrawingToolInterface__setupOutgoingEvents_closure10";
  $desc = $collectedClasses.DrawingToolInterface__setupOutgoingEvents_closure10;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingToolInterface__setupOutgoingEvents_closure10.prototype = $desc;
  function DrawingToolInterface__setupOutgoingEvents_closure11(this_15) {
    this.this_15 = this_15;
  }
  DrawingToolInterface__setupOutgoingEvents_closure11.builtin$cls = "DrawingToolInterface__setupOutgoingEvents_closure11";
  if (!"name" in DrawingToolInterface__setupOutgoingEvents_closure11)
    DrawingToolInterface__setupOutgoingEvents_closure11.name = "DrawingToolInterface__setupOutgoingEvents_closure11";
  $desc = $collectedClasses.DrawingToolInterface__setupOutgoingEvents_closure11;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingToolInterface__setupOutgoingEvents_closure11.prototype = $desc;
  ...
  function SiteApp__onPublishRequested_closure() {
  }
  SiteApp__onPublishRequested_closure.builtin$cls = "SiteApp__onPublishRequested_closure";
  if (!"name" in SiteApp__onPublishRequested_closure)
    SiteApp__onPublishRequested_closure.name = "SiteApp__onPublishRequested_closure";
  $desc = $collectedClasses.SiteApp__onPublishRequested_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SiteApp__onPublishRequested_closure.prototype = $desc;
  function SiteApp__onPublishRequested__closure(responseJson_0) {
    this.responseJson_0 = responseJson_0;
  }
  SiteApp__onPublishRequested__closure.builtin$cls = "SiteApp__onPublishRequested__closure";
  if (!"name" in SiteApp__onPublishRequested__closure)
    SiteApp__onPublishRequested__closure.name = "SiteApp__onPublishRequested__closure";
  $desc = $collectedClasses.SiteApp__onPublishRequested__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SiteApp__onPublishRequested__closure.prototype = $desc;
  ...
  function TopMenuController__setupDropdown_closure0() {
  }
  TopMenuController__setupDropdown_closure0.builtin$cls = "TopMenuController__setupDropdown_closure0";
  if (!"name" in TopMenuController__setupDropdown_closure0)
    TopMenuController__setupDropdown_closure0.name = "TopMenuController__setupDropdown_closure0";
  $desc = $collectedClasses.TopMenuController__setupDropdown_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TopMenuController__setupDropdown_closure0.prototype = $desc;
