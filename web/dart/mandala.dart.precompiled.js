...
function dart_precompiled($collectedClasses) {
  ...
  TouchEvent0.prototype.get$touches = function(receiver) {
  ...
  function DrawingTool(sides, isMirrored, _canvas, _ctx, _bgGradient, _canvasRect, _winScroll, _rafId, _isDragging, actionQueue, backgroundBitmap, bitmapData) {
    this.sides = sides;
  ...
  function DrawingTool_setupListeners_closure(this_0) {
    this.this_0 = this_0;
  }
  DrawingTool_setupListeners_closure.builtin$cls = "DrawingTool_setupListeners_closure";
  if (!"name" in DrawingTool_setupListeners_closure)
    DrawingTool_setupListeners_closure.name = "DrawingTool_setupListeners_closure";
  $desc = $collectedClasses.DrawingTool_setupListeners_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingTool_setupListeners_closure.prototype = $desc;
  function DrawingTool_setupListeners_closure0(this_1) {
    this.this_1 = this_1;
  }
  DrawingTool_setupListeners_closure0.builtin$cls = "DrawingTool_setupListeners_closure0";
  if (!"name" in DrawingTool_setupListeners_closure0)
    DrawingTool_setupListeners_closure0.name = "DrawingTool_setupListeners_closure0";
  $desc = $collectedClasses.DrawingTool_setupListeners_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingTool_setupListeners_closure0.prototype = $desc;
  function DrawingTool_setupListeners_closure1(this_2) {
    this.this_2 = this_2;
  }
  DrawingTool_setupListeners_closure1.builtin$cls = "DrawingTool_setupListeners_closure1";
  if (!"name" in DrawingTool_setupListeners_closure1)
    DrawingTool_setupListeners_closure1.name = "DrawingTool_setupListeners_closure1";
  $desc = $collectedClasses.DrawingTool_setupListeners_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingTool_setupListeners_closure1.prototype = $desc;
  function DrawingTool_setupListeners_closure2(this_3) {
    this.this_3 = this_3;
  }
  DrawingTool_setupListeners_closure2.builtin$cls = "DrawingTool_setupListeners_closure2";
  if (!"name" in DrawingTool_setupListeners_closure2)
    DrawingTool_setupListeners_closure2.name = "DrawingTool_setupListeners_closure2";
  $desc = $collectedClasses.DrawingTool_setupListeners_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingTool_setupListeners_closure2.prototype = $desc;
  function DrawingTool_setupListeners_closure3(this_4) {
    this.this_4 = this_4;
  }
  DrawingTool_setupListeners_closure3.builtin$cls = "DrawingTool_setupListeners_closure3";
  if (!"name" in DrawingTool_setupListeners_closure3)
    DrawingTool_setupListeners_closure3.name = "DrawingTool_setupListeners_closure3";
  $desc = $collectedClasses.DrawingTool_setupListeners_closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingTool_setupListeners_closure3.prototype = $desc;
  function DrawingTool_setupListeners_closure4(this_5) {
    this.this_5 = this_5;
  }
  DrawingTool_setupListeners_closure4.builtin$cls = "DrawingTool_setupListeners_closure4";
  if (!"name" in DrawingTool_setupListeners_closure4)
    DrawingTool_setupListeners_closure4.name = "DrawingTool_setupListeners_closure4";
  $desc = $collectedClasses.DrawingTool_setupListeners_closure4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingTool_setupListeners_closure4.prototype = $desc;
  function DrawingTool_setupListeners_closure5(this_6) {
    this.this_6 = this_6;
  }
  DrawingTool_setupListeners_closure5.builtin$cls = "DrawingTool_setupListeners_closure5";
  if (!"name" in DrawingTool_setupListeners_closure5)
    DrawingTool_setupListeners_closure5.name = "DrawingTool_setupListeners_closure5";
  $desc = $collectedClasses.DrawingTool_setupListeners_closure5;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingTool_setupListeners_closure5.prototype = $desc;
  function DrawingTool_setupListeners_closure6(this_7) {
    this.this_7 = this_7;
  }
  DrawingTool_setupListeners_closure6.builtin$cls = "DrawingTool_setupListeners_closure6";
  if (!"name" in DrawingTool_setupListeners_closure6)
    DrawingTool_setupListeners_closure6.name = "DrawingTool_setupListeners_closure6";
  $desc = $collectedClasses.DrawingTool_setupListeners_closure6;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingTool_setupListeners_closure6.prototype = $desc;
  function DrawingTool_setupListeners_closure7(this_8) {
    this.this_8 = this_8;
  }
  DrawingTool_setupListeners_closure7.builtin$cls = "DrawingTool_setupListeners_closure7";
  if (!"name" in DrawingTool_setupListeners_closure7)
    DrawingTool_setupListeners_closure7.name = "DrawingTool_setupListeners_closure7";
  $desc = $collectedClasses.DrawingTool_setupListeners_closure7;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingTool_setupListeners_closure7.prototype = $desc;
  function DrawingTool_setupListeners_closure8(this_9) {
    this.this_9 = this_9;
  }
  DrawingTool_setupListeners_closure8.builtin$cls = "DrawingTool_setupListeners_closure8";
  if (!"name" in DrawingTool_setupListeners_closure8)
    DrawingTool_setupListeners_closure8.name = "DrawingTool_setupListeners_closure8";
  $desc = $collectedClasses.DrawingTool_setupListeners_closure8;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingTool_setupListeners_closure8.prototype = $desc;
  function DrawingTool_setupListeners_closure9(this_10) {
    this.this_10 = this_10;
  }
  DrawingTool_setupListeners_closure9.builtin$cls = "DrawingTool_setupListeners_closure9";
  if (!"name" in DrawingTool_setupListeners_closure9)
    DrawingTool_setupListeners_closure9.name = "DrawingTool_setupListeners_closure9";
  $desc = $collectedClasses.DrawingTool_setupListeners_closure9;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingTool_setupListeners_closure9.prototype = $desc;
  function DrawingTool__update_closure(this_0) {
    this.this_0 = this_0;
  }
  DrawingTool__update_closure.builtin$cls = "DrawingTool__update_closure";
  if (!"name" in DrawingTool__update_closure)
    DrawingTool__update_closure.name = "DrawingTool__update_closure";
  $desc = $collectedClasses.DrawingTool__update_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingTool__update_closure.prototype = $desc;
  ...
  function PolygonalFillAction(_activePoints, _potentialPoint, points, name, settings) {
    this._activePoints = _activePoints;
    this._potentialPoint = _potentialPoint;
    this.points = points;
    this.name = name;
    this.settings = settings;
  }
  ...
  function PolygonalStrokeAction(_activePoints, _potentialPoint, points, name, settings) {
    this._activePoints = _activePoints;
    this._potentialPoint = _potentialPoint;
    this.points = points;
    this.name = name;
  ...
  function SmoothStrokeAction(_activePoints, points, name, settings) {
    this._activePoints = _activePoints;
    this.points = points;
    this.name = name;
    this.settings = settings;
  ...
  function DrawingToolInterface(_drawingModule, _lastSelectedTool, _DrawingToolLib$_$slideCountSlider, _DrawingToolLib$_$opacitySlider) {
    this._drawingModule = _drawingModule;
    this._lastSelectedTool = _lastSelectedTool;
    this._DrawingToolLib$_$slideCountSlider = _DrawingToolLib$_$slideCountSlider;
  ...
  function DrawingToolInterface_closure(this_0) {
    this.this_0 = this_0;
  }
  DrawingToolInterface_closure.builtin$cls = "DrawingToolInterface_closure";
  if (!"name" in DrawingToolInterface_closure)
    DrawingToolInterface_closure.name = "DrawingToolInterface_closure";
  $desc = $collectedClasses.DrawingToolInterface_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingToolInterface_closure.prototype = $desc;
  function DrawingToolInterface__closure(this_1, el_2) {
    this.this_1 = this_1;
    this.el_2 = el_2;
  }
  DrawingToolInterface__closure.builtin$cls = "DrawingToolInterface__closure";
  if (!"name" in DrawingToolInterface__closure)
    DrawingToolInterface__closure.name = "DrawingToolInterface__closure";
  $desc = $collectedClasses.DrawingToolInterface__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingToolInterface__closure.prototype = $desc;
  function DrawingToolInterface_closure0(this_3) {
    this.this_3 = this_3;
  }
  DrawingToolInterface_closure0.builtin$cls = "DrawingToolInterface_closure0";
  if (!"name" in DrawingToolInterface_closure0)
    DrawingToolInterface_closure0.name = "DrawingToolInterface_closure0";
  $desc = $collectedClasses.DrawingToolInterface_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingToolInterface_closure0.prototype = $desc;
  function DrawingToolInterface__closure0(this_4, el_5) {
    this.this_4 = this_4;
    this.el_5 = el_5;
  }
  DrawingToolInterface__closure0.builtin$cls = "DrawingToolInterface__closure0";
  if (!"name" in DrawingToolInterface__closure0)
    DrawingToolInterface__closure0.name = "DrawingToolInterface__closure0";
  $desc = $collectedClasses.DrawingToolInterface__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingToolInterface__closure0.prototype = $desc;
  function DrawingToolInterface_closure1(this_6, mirrorCheckbox_7) {
    this.this_6 = this_6;
    this.mirrorCheckbox_7 = mirrorCheckbox_7;
  }
  DrawingToolInterface_closure1.builtin$cls = "DrawingToolInterface_closure1";
  if (!"name" in DrawingToolInterface_closure1)
    DrawingToolInterface_closure1.name = "DrawingToolInterface_closure1";
  $desc = $collectedClasses.DrawingToolInterface_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingToolInterface_closure1.prototype = $desc;
  function DrawingToolInterface_closure2(this_8) {
    this.this_8 = this_8;
  }
  DrawingToolInterface_closure2.builtin$cls = "DrawingToolInterface_closure2";
  if (!"name" in DrawingToolInterface_closure2)
    DrawingToolInterface_closure2.name = "DrawingToolInterface_closure2";
  $desc = $collectedClasses.DrawingToolInterface_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingToolInterface_closure2.prototype = $desc;
  function DrawingToolInterface_closure3(this_9) {
    this.this_9 = this_9;
  }
  DrawingToolInterface_closure3.builtin$cls = "DrawingToolInterface_closure3";
  if (!"name" in DrawingToolInterface_closure3)
    DrawingToolInterface_closure3.name = "DrawingToolInterface_closure3";
  $desc = $collectedClasses.DrawingToolInterface_closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingToolInterface_closure3.prototype = $desc;
  function DrawingToolInterface_onWantsToChangeAction_closure() {
  }
  DrawingToolInterface_onWantsToChangeAction_closure.builtin$cls = "DrawingToolInterface_onWantsToChangeAction_closure";
  if (!"name" in DrawingToolInterface_onWantsToChangeAction_closure)
    DrawingToolInterface_onWantsToChangeAction_closure.name = "DrawingToolInterface_onWantsToChangeAction_closure";
  $desc = $collectedClasses.DrawingToolInterface_onWantsToChangeAction_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DrawingToolInterface_onWantsToChangeAction_closure.prototype = $desc;
  ...
  function Stage(_stagexl$_canvas, _context, _sourceWidth, _sourceHeight, _frameRate, _canvasWidth, _canvasHeight, _contentRectangle, _clientTransformation, _stageTransformation, _renderLoop, _juggler, _focus, _renderState, _stageRenderMode, _stageScaleMode, _stageAlign, _mouseCursor, _mousePosition, _mouseTarget, _mouseButtons, _touches, _mouseEvent, _touchEvent, _touchEventSubscriptions, _children, _mouseChildren, _tabChildren, doubleClickEnabled, mouseEnabled, tabEnabled, tabIndex, _stagexl$_id, _x, _y, _pivotX, _pivotY, _scaleX, _scaleY, _skewX, _skewY, _rotation, _alpha, _visible, _off, _mask, _cache, _cacheRectangle, _cacheDebugBorder, _filters, _shadow, _compositeOperation, _stagexl$_name, _parent, _tmpMatrix, _transformationMatrix, _transformationMatrixRefresh, _eventStreams) {
    this._stagexl$_canvas = _stagexl$_canvas;
    this._context = _context;
    this._sourceWidth = _sourceWidth;
    this._sourceHeight = _sourceHeight;
  ...
  BitmapFilter.builtin$cls = "BitmapFilter";
  if (!"name" in BitmapFilter)
    BitmapFilter.name = "BitmapFilter";
  $desc = $collectedClasses.BitmapFilter;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BitmapFilter.prototype = $desc;
